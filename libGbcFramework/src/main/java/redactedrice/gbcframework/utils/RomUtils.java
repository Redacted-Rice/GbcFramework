...
public final class RomUtils {
    ...
    public static int convertToGlobalAddressFromLoadedBankOffset(byte bank,
            short loadedBankAddress) {
    ...
    public static short convertFromBankOffsetToLoadedOffset(BankAddress pointerAddress) {
        return convertFromBankOffsetToLoadedOffset(pointerAddress.getBank(),
                pointerAddress.getAddressInBank());
    }
}
