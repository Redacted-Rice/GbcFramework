...
public class StringUtils {
    ...
    public static boolean isFormattedValidly(List<String> blocksOfText, int maxCharsPerLine,
            int maxLines, int maxBlocks) {
    ...
    public static List<String> prettyFormatText(String text, int maxCharsPerLine,
            int maxLinesPerBlock, int preferedLinesPerBlock, int maxNumberOfBlocks) {
        ...
        // subtracting one from the count makes it so that a full page or anything less doesn't
        // count
    ...
    public static List<String> packFormatText(String text, int charsPerLine, int maxLinesPerBlock,
